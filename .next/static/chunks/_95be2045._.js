...
const FavoritesPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FavoritesPage.useEffect": ()=>{
            ...
            const favorites = allCharities.filter({
                "FavoritesPage.useEffect.favorites": (charity)=>favoriteIds.includes(charity.id)
            }["FavoritesPage.useEffect.favorites"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FavoritesPage.useEffect": ()=>{
            const handleFocus = {
                "FavoritesPage.useEffect.handleFocus": ()=>{
                    const favoriteIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$favorites$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFavorites"])();
                    const allCharities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$charities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllCharities"])();
                    const favorites = allCharities.filter({
                        "FavoritesPage.useEffect.handleFocus.favorites": (charity)=>favoriteIds.includes(charity.id)
                    }["FavoritesPage.useEffect.handleFocus.favorites"]);
                    setFavoriteCharities(favorites);
                }
            }["FavoritesPage.useEffect.handleFocus"];
            window.addEventListener('focus', handleFocus);
            return ({
                "FavoritesPage.useEffect": ()=>window.removeEventListener('focus', handleFocus)
            })["FavoritesPage.useEffect"];
        }
    }["FavoritesPage.useEffect"], []);
    if (isLoading) {
...
_s(FavoritesPage, "KFUat5xBu7l1PLz5RXAsuB0i2dU=");
_c = FavoritesPage;
...
//# sourceMappingURL=_95be2045._.js.map